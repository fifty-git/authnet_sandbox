...
if ($_POST['post_token']) {
  ...
  $returnArray = $authorizeNetCore->createPaymentProfile($_POST);

  if (!is_null($returnArray['payment_profile_id'])) {
    $profileId = $returnArray['payment_profile_id'];
    $returnMessage = 'Created new payment profile!'; 
  }
  else {
    $profileId = null;
...
<form action="create_payment_profile_form.php" method="POST">
<input type="hidden" name="customerProfileId" value="1200355109">
<input type="hidden" name="merchantCustomerId" value="76767676">
